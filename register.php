        ...
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    <h1 class="login-title text-white" style="background: black;">Register</h1>
                    <p class="p-1 m-0 font-ubuntu text-white" style="background: black;">Register and enjoy additional features</p>
                    <span class="font-ubuntu text-white" style="background: black;">I already have <a href="index.php">Login</a></span>
                </div>
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <div class="d-flex justify-content-center">
                            <img class="camera-icon" src="img/camera-solid.svg" alt="camera">
                        </div>
                        <img src="img/beard.png" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                        <small class="form-text text-white" style="background: black;">Choose Image (may not appear or appear distorted here, but will appear correctly on site)</small>
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label for="agreement" class="form-check-label font-ubuntu text-white" style="background: black;">I have read and agree to the <a href="terms.html">terms and conditions</a>.(*) </label>
                        </div>
