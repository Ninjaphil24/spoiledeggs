...
<li><a href="www.offenbachgp.com" target="_blank">Offenbach GP</a></li>
  ...
  <a href="indexappl.php">Rank by Applause</a>
  <a href="indexeggs.php" class="active">Negative Rank (Eggs)</a>
  </div>
...
<ul>
  ...
  <?php
    ...
    $sql = "SELECT * FROM entry ORDER BY dislike_count DESC LIMIT $offset, $total_records_per_page";
